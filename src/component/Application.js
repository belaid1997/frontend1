...
function Row(props) {
  ...
  return (
    <React.Fragment>
      <TableRow id="table_lien" className={classes.root} 
      style={{
        ...
        <TableCell style={{ paddingBottom: 0, paddingTop: 0 }} colSpan={6}>
          <Collapse in={open} timeout="auto" unmountOnExit>
            <Box margin={1}>
              ...
              style={{
        backgroundColor: '#F3AD7C'
      }}>
                <TableHead>
                  <TableRow>
                  <TableCell>ID lien</TableCell>
                    <TableCell>lien URL</TableCell>
    ...
    <TableContainer component={Paper}>
      <Table aria-label="collapsible table">
        <TableHead>
          <TableRow>
            <TableCell />
            <TableCell >id application</TableCell>
            <TableCell>application</TableCell>
            <TableCell align="right">date d'ajoute</TableCell>
